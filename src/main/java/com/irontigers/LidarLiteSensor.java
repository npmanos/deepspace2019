...
public class LidarLiteSensor {
    ...
    private static byte[] mDistance;
    private static java.util.Timer mUpdater;
    private static boolean mHasSignal;
    public static double distCm;
